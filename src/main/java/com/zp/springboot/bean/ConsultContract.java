package com.zp.springboot.bean;
...
public class ConsultContract implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 331238139891143L;
	 ...
	 * 3.Sequence：通过序列产生主键，通过@SequenceGenterator注解指定序列名，mysql不支持这正方式；
